...
function setup() {
  ...
  groundColl = Bodies.rectangle(450,390,900,22,ground_options1);

  stroke("skyblue");
  shooterObj = new Slingshot(polygon,{x:150,y:180});
...
function draw() {
  ...
  textSize(25);
  fill("green");
  text("Press Space To Get A Second Chance!!!!",20,100);
  fill("orange");
  text("Drag The Polygon To Shoot!!!!",510,285);
  fill("light green");
  text("Shots Left: "+shots,20,30);
